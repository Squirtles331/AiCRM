...
- 当前冻结序列为 V1 基线、V2 单轨保留版本、V3 权限与组织、V4 公海规则、V5 销售增强、V6 可靠性、V7 约束和索引、V8 自动回收目标与系统任务操作者、V9 身份字段与旧表退出、V10-V13 销售交易前置域、V14-V16 合同订单物理基线、V17 合同订单生命周期闭环。正常发布后迁移不可改 checksum；本次单轨切换已显式废弃旧开发库，因此旧库必须重建后才能继续开发。
