...
本目录是后端研发、测试和评审的架构基线。当前已交付工程底座、线索/客户私海公海闭环、阶段 2A 的产品与价格目录、阶段 2B 的商机管道、阶段 2C 的报价根/版本/快照行，以及阶段 2D 的审批定义与报价审批闭环。阶段 3 已冻结合同与订单物理模型，首切片已覆盖“获批报价创建草稿、提交签署、确认签署、从已签合同创建订单草稿”；订单确认/取消、合同变更、作废、ERP 回传、交付、财务和售后仍按阶段门逐项交付。
...
| trade | 报价、报价版本、报价快照行、销售合同与签署状态；后续合同变更、销售订单 | 实际库存与发货 |
...
- [阶段 3 合同与订单设计](contract-order.md)
